...
- 경기 상세 박스스코어에서 매칭된 선수 기록을 바로 열 수 있도록 기록실 진입점을 강화
- 박스스코어 타자/투수 카드에 루타, 장타, SLG, 투구수, 게임 ERA, WHIP 같은 경기 단위 확장 지표를 표시
- 박스스코어 탭에 팀 비교 카드와 선수별 상세 기록 펼침을 추가해 득점/안타/장타/탈삼진 비교, 시즌 미니 지표, 멀티히트/무자책 같은 경기 맥락을 한 화면에서 확인할 수 있도록 개선
