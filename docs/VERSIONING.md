...
- Flutter app version: `0.0.15+15`
- Current release tag: `0.0.15`
...
- In-app patch note heading: app version with build, for example `0.0.15+15 - Standings Bootstrap Cleanup`
