...
- Flutter app version: `0.0.25+25`
- Current release tag: `0.0.25`
...
- In-app patch note heading: app version with build, for example `0.0.25+25 - Missing Team Totals Guard`
