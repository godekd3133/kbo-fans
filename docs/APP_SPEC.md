...
| 타자 테이블 | 타순 정렬. 타수/득점/안타/타점 + 합계 행. 선수 프로필 매칭 시 `선수 기록 보기` 진입점 노출. 원천이 제공한 경우 루타/장타/SLG/볼넷/사구/삼진/도루 chip 표시 |
| 투수 테이블 | 등판 순서. 이닝/안타/삼진/사사구/자책. 선수 프로필 매칭 시 `선수 기록 보기` 진입점 노출. 원천이 제공한 경우 투구수/실점 chip 표시, 이닝 기준 게임 ERA/WHIP 파생 표시 |
...
- 시즌 OPS/ERA 같은 누적 지표는 선수 상세/기록실에서 확인한다. 박스스코어 탭은 경기 단위로 검증 가능한 SLG/루타/게임 ERA/WHIP만 표시한다.
